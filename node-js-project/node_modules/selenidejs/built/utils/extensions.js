...
(function (Extensions) {
    ...
    function toBy(cssOrXpathOrBy) {
        if (cssOrXpathOrBy instanceof selenium_webdriver_1.By) {
            return cssOrXpathOrBy;
        }
        const cssOrXpath = cssOrXpathOrBy.trim();
        const isXpath = (str) => str.startsWith('/') || str.startsWith('./') || str.startsWith('..') || str.startsWith('(');
        return isXpath(cssOrXpath) ? by_1.by.xpath(cssOrXpath) : by_1.by.css(cssOrXpath);
    }
