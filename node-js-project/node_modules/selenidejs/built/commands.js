...
(function (command) {
    ...
    (function (js) {
        ...
        js.clickWithOffset = (xOffset, yOffset) => utils_1.lambda(`click by js with offset - x: ${xOffset}, y: ${yOffset}`, async (element) => {
            await element.executeScript((element, args, window) => {
        ...
        js.setValue = (value) => utils_1.lambda(`set value by js: ${value}`, async (element) => {
            await element.executeScript((element, args) => {
                const text = args[0];
        ...
        js.scrollIntoView = utils_1.lambda('scroll into view', async (element) => element.executeScript((element) => element.scrollIntoView(true)));
