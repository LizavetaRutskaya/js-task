...
class Entity {
    constructor(configuration) {
        ...
        this.wait = new wait_1.Wait(this, configuration.timeout);
    }
    /*
    ...
    async should(...conditions) {
        await this.wait.for(wait_1.Condition.all(...conditions));
        return this;
    }
    /* Matchable */
    async waitUntil(...conditions) {
        return this.wait.until(wait_1.Condition.all(...conditions));
    }
