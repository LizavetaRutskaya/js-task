...
const BrowserWebElementByJs_1 = require("./locators/BrowserWebElementByJs");
const BrowserWebElementByLocator_1 = require("./locators/BrowserWebElementByLocator");
const BrowserWebElementsByJs_1 = require("./locators/BrowserWebElementsByJs");
...
class Browser extends entity_1.Entity {
    ...
    static chromeWith() {
        return Browser
            .configuredWith().driver(new selenium_webdriver_1.Builder().withCapabilities(selenium_webdriver_1.Capabilities.chrome()).build());
    }
    static chrome() {
    ...
    with(customConfig) {
        return new Browser(new configuration_1.Configuration(Object.assign(Object.assign({}, this.configuration), customConfig)));
    }
    get driver() {
    ...
    element(located, customized) {
        ...
        if (located instanceof selenium_webdriver_1.By || typeof located === 'string') {
            const by = extensions_1.Extensions.toBy(located);
            ...
            const locator = new BrowserWebElementByJs_1.BrowserWebElementByJs(this, located.script, located.args);
            return new element_1.Element(locator, configuration);
        }
    }
    all(located, customized) {
        ...
        if (located instanceof selenium_webdriver_1.By || typeof located === 'string') {
            ...
            const locator = new BrowserWebElementsByJs_1.BrowserWebElementsByJs(this, located.script, located.args);
            return new collection_1.Collection(locator, configuration);
        }
    }
    /* Commands */
