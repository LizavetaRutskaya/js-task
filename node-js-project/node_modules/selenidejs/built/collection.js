...
const collectedByLocator_1 = require("./locators/collectedByLocator");
...
class Collection extends entity_1.Entity {
    ...
    with(customConfig) {
        return new Collection(this.locator, new configuration_1.Configuration(Object.assign(Object.assign({}, this.configuration), customConfig)));
    }
    ...
    collected(searchFunction) {
        return new Collection(new collectedByLocator_1.CollectedByLocator(searchFunction, this), this.configuration);
    }
