...
export declare namespace perform {
    ...
    const resizeWindow: (width: any, height: any) => (browser: Browser) => Promise<Browser>;
    ...
    const executeScript: (script: string | ((document: Document) => any), ...args: any[]) => (browser: Browser) => Promise<unknown>;
}
